      ...
      <Container customClasses="lg:absolute lg:left-1/2 lg:-translate-x-1/2">
        ...
        >
          ...
          <div className="flex pt-8 gap-4">
            ...
            <Link
              href="https://www.instagram.com/workonsolana/"
              target="_blank"
              rel="noreferrer"
              className="text-black hover:text-yellow-btn-primary transition-colors duration-300"
            >
            ...
            <Link
              href="https://t.me/HowToMakeMoneyCTOwork"
              target="_blank"
              rel="noreferrer"
              className="text-black hover:text-yellow-btn-primary transition-colors duration-300"
            >
              <svg
                ...
                className="fill-current"
              >
                <path d="M32 2C15.4 2 2 15.4 2 32C2 48.6 15.4 62 32 62C48.6 62 62 48.6 62 32C62 15.4 48.6 2 32 2ZM47.2 19.8L41.4 46.8C40.9 48.6 39.8 49.1 38.3 48.2L30.4 42.4L26.6 46.1C26.2 46.5 25.8 46.8 25.1 46.8L25.7 38.7L41.9 24C42.6 23.4 41.7 23 40.8 23.6L20.9 36.8L13.2 34.3C11.5 33.7 11.4 32.5 13.6 31.6L44.8 19.1C46.3 18.5 47.6 19.4 47.2 19.8Z" />
              </svg>
            </Link>
